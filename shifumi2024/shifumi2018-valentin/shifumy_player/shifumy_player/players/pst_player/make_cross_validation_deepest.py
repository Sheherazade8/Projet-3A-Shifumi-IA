...
from .agent.Agent import DeepestPstAgent
from ._cross_validation import validation, write_win_lose_draw_results_in_file\
                                , play_sequence, get_wld_agent_in_history


from .defs import path_datasets, path_misc_crossvalid_lastnode, list_data_file
...
validation_file = open(path_misc_crossvalid_lastnode, "w")
winrate = 0
