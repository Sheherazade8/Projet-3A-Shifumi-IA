...
- **knn_from_csv.ipynb**: Notebook implementing gesture recognition using KNN with landmarks data loaded from a CSV file and using Mediapipe.
- **references.docx**: Word file containing links to the references and resources used for the implementation of gesture recognition algorithms.
